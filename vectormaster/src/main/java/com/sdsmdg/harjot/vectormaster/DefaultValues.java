...
public class DefaultValues {
    ...
    public final static Paint.Join PATH_STROKE_LINE_JOIN = Paint.Join.ROUND;
    ...
    public final static float VECTOR_VIEWPORT_WIDTH = 50.0f;
    public final static float VECTOR_VIEWPORT_HEIGHT = 50.0f;
    public final static float VECTOR_WIDTH = 50.0f;
    public final static float VECTOR_HEIGHT = 50.0f;
